@extends('master')
@section('header')
<title>Attorlytic - Rene Raniels</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h2 class="page-title"> Rene Raniels
                    </h2>
                    <ul class="page-list">
                        <li><a href="/">Home</a></li>
                        <li><a href="#"> Rene Raniels
                            </a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="appointment-details-item">
                    <div class="top-part">
                        <div class="thumb">
                            <img src="assets/uploads/media-uploader/ab-11622624236.png"
                                class="full" alt />
                        </div>
                        <div class="content">
                            <span class="designation">Assosiate, Attorg</span>
                            <h2 class="title">Rene Raniels</h2>
                            ...
                            <div class="location"><i class="fas fa-map-marked-alt"></i> Sydney, Australia</div>
                            ...
                            <div class="social-share-wrap">
                                <ul class="social-share">
                                    <li><a class="facebook"
                                            href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Frene-raniels-27%2F40"><i
                                                class="fab fa-facebook-f"></i></a></li>
                                    <li><a class="twitter"
                                            href="https://twitter.com/intent/tweet?text=&amp;url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Frene-raniels-27%2F40&amp;via=Crunchify"><i
                                                class="fab fa-twitter"></i></a></li>
                                    <li><a class="linkedin"
                                            href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Frene-raniels-27%2F40&amp;title="><i
                                                class="fab fa-linkedin-in"></i></a></li>
                                    <li><a class="pinterest"
                                            href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Frene-raniels-27%2F40&amp;media=100&amp;description="><i
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade " id="nav-profile" role="tabpanel">
                                                            ...
                                                            <form
                                                                ...
                                                                <input type="hidden" name="appointment_id" value="40">
                                                                <div class="form-group">
                                        ...
                                        <ul class="feedback-list">
                                            <li class="single-feedback-item">
                                                <div class="content">
                                                    ...
                                                    <div class="description">cccc</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
