@extends('master')
@section('header')
<title>Attorlytic - David Finch</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h2 class="page-title"> David Finch
                    </h2>
                    <ul class="page-list">
                        <li><a href="/">Home</a></li>
                        <li><a href="#"> David Finch
                            </a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="appointment-details-item">
                    <div class="top-part">
                        <div class="thumb">
                            <img src="assets/uploads/media-uploader/ab-61622624237.png"
                                class="full" alt="mmm" />
                        </div>
                        <div class="content">
                            <span class="designation">Assosiate, Attorg</span>
                            <h2 class="title">David Finch</h2>
                            ...
                            <div class="location"><i class="fas fa-map-marked-alt"></i> Tehran, Iran</div>
                            <div class="price-wrap">
                                <h4 class="price">Fee: <span>$400</span></h4>
                            </div>
                            <div class="social-share-wrap">
                                <ul class="social-share">
                                    <li><a class="facebook"
                                            href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Fdavid-finch%2F35"><i
                                                class="fab fa-facebook-f"></i></a></li>
                                    <li><a class="twitter"
                                            href="https://twitter.com/intent/tweet?text=&amp;url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Fdavid-finch%2F35&amp;via=Crunchify"><i
                                                class="fab fa-twitter"></i></a></li>
                                    <li><a class="linkedin"
                                            href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Fdavid-finch%2F35&amp;title="><i
                                                class="fab fa-linkedin-in"></i></a></li>
                                    <li><a class="pinterest"
                                            href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fxgenious.com%2Flaravel%2Fattorg%2Fappointment%2Fdavid-finch%2F35&amp;media=105&amp;description="><i
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade " id="nav-profile" role="tabpanel">
                                                            ...
                                                            <form
                                                                ...
                                                                <input type="hidden" name="appointment_id" value="35">
                                                                <div class="form-group">
