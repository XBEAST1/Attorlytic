@extends('master')
@section('header')
<title>Attorlytic - Raise your voice against laws</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h2 class="page-title"> Raise your voice against laws.
                    </h2>
                    <ul class="page-list">
                        <li><a href="/">Home</a></li>
                        <li><a href="#"> Raise your voice against laws.
                            </a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-details-item">
                    ...
                    <p>
                    <ol>
                        <li><span style="color:rgb(135,138,149);font-family:Poppins, sans-serif;font-size:16px;">Allow
                                ...
                                aware merit small his. Charmed esteems luckily age out.</span><span
                                ...
                                indulgence unreserved connection alteration appearance my an astonished. Up as seen sent
                                make he they of. Her raising and himself pasture believe females. Fancy she stuff after
                                aware merit small his. Charmed esteems luckily age out.</span><br></li>
                    </ol>
                    </p>
                </div>
                <div class="blog-details-footer">
                    <div class="left">
                        <ul class="tags">
                            ...
                            <li><a href="blog-tags/divorce">divorce</a></li>
                        </ul>
                    </div>
                </div>
