@extends('master')
@section('header')
<title>Attorlytic - Price Plan Enterprise</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h2 class="page-title"> Order For : Enterprise
                    </h2>
                    <ul class="page-list">
                        <li><a href="/">Home</a></li>
                        <li><a href="#"> Order For : Enterprise
                            </a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade " id="nav-profile" role="tabpanel">
                                <form action="place-order" method="post"
                                    ...
                                    <div class="form-group btn-wrapper">
                                        <button class="boxed-btn btn-saas btn-block" type="submit"
                                            id="order_pkg_btn">Order Package</button>
                                    </div>
                                </form>
                            </div>
                        </div>
